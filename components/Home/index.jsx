            ...
            <div className="flex flex-col justify-center text-left text-5xl">
              ...
              <div className="flex mt-5 gap-x-2">
                ...
                <Link href="https://www.linkedin.com/in/azharngrh/">
                  <button
                    type="button"
                    class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-1.5 py-1.5 text-center"
                  >
                ...
                <Link href="https://drive.google.com/file/d/1gaGf0xlLRRIirIkEdGs9qjj-Lu7Gkf22/view?usp=sharing">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" height="2em" width="2em" id="cv">
                      <g fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="3" className="stroke-amber-500">
