            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start gap-x-2">
                <div className="flex items-center">
                  <svg height={40} width={40} viewBox="0 0 400 400">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <polygon
                        class="cls-3 fill-[#187c8c]"
                      ...
                      />
                      <polygon class="cls-1 fill-[#11526d]" points="201.47 98.64 100.5 156.92 92.2 172.06 92.2 229.84 92.46 229.98 201.47 167.69 201.47 98.64" />
                      <polygon class="cls-2 fill-[#1d6278]" points="310.2 172.73 303.07 157.47 201.47 98.64 201.47 167.56 310.2 229.69 310.2 172.73" />
                      <path class="cls-3 fill-[#187c8c]" d="m201.47,167.56v.13l-109.01,62.29,97.64,56.39,2.61,1.5h17.01c.26,0,1.39-.53,3.23-1.5,17.33-9.1,97.25-56.54,97.25-56.54v-.14l-108.73-62.13Z" />
                    </g>
                  </svg>
                </div>
                <div className="flex items-center">
